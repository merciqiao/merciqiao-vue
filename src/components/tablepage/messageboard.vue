    ...
    <div class="container">
        ...
        <el-form :label-position="labelPosition" :label-width="labelWidth" :inline="true" :model="formSearch" class="demo-form-inline">
            ...
            <el-form-item label="年龄">
                <el-input v-model="formSearch.user" placeholder="年龄"></el-input>
            </el-form-item>
            <el-form-item label="性别">
                <el-input v-model="formSearch.user" placeholder="性别"></el-input>
            </el-form-item>
        ...
        <el-table :data="tableData" border stripe style="width: 100%" @selection-change="handleSelectionChange">
            ...
            <el-table-column prop="date" label="创建日期" width="180" sortable>
            </el-table-column>
            ...
            <el-table-column prop="address" label="留言内容">
            </el-table-column>
